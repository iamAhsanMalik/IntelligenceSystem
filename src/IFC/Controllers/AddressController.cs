...
public class AddressController : Controller
{
    ...
    {
        List<Address>? iFCDbContext = await _unitOfWork.AddressRepo.GetAddressesAsync();
    ...
    public async Task<IActionResult> Details(long? id)
    {
        ...
        var address = await _unitOfWork.AddressRepo.GetAddressesAsync(id);
        if (address == null)
        {
            return NotFound();
        }
    ...
    {
        ViewData["CityId"] = new SelectList(await _unitOfWork.CityRepo.GetCitiesAsync(), "Id", "Name");
        ViewData["DistrictId"] = new SelectList(await _unitOfWork.DistrictRepo.GetDistrictsAsync(), "Id", "Name");
        return View();
    }
    // POST: Address/Create
